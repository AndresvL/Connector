...
public class WorkOrderExtended {
	private String id, workorderNr, projectNr, workDate, customerEmailInvoice, customerEmail, customerDebtorNr, status,
			...
			workDescription, modified, pdfUrl, workStatus, employeeNr;
	// line
	private ArrayList<Material> materials;
	private ArrayList<WorkPeriod> workPeriods;
	private ArrayList<Relation> relations;
	private ArrayList<WOAObject> objects;
	
	public WorkOrderExtended(String projectNr, String workDate, String customerEmailInvoice, String customerEmail,
			...
			String workEndDate, String workEndTime, String externProjectNr, String typeOfWork, String workDescription,
			String modified, String pdfUrl, String workStatus, String employeeNr, ArrayList<WOAObject> object) {
	...
	public ArrayList<WOAObject> getObjects() {
		return objects;
	}
	
	public void setObjects(ArrayList<WOAObject> objects) {
