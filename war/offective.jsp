...
<title>Offective Connection</title>
<!-- datepicker CSS -->
<link
...
<body>
	...
	<div id="WBA-section">
		...
		<img src="./img/logo-Offective.png" height="80" width="150"
			id="boekhoud_logo" />
	</div>
	<div class="settings">
		...
		<div class="panel-group">
				...
				<div class="modal-content" id="loginContent">
					<form action="OAuth.do">
						<input type="hidden" value="${softwareToken}" name="token"
							id="softwareToken" />
						<input type="hidden" value="Offective" name="softwareName"
							id="softwareName" />
						...
						<table>
							...
							<tr>
								<td><label>Securitycode Offective</label> <img
										src="./img/vraagteken.jpg" data-toggle="tooltip"
										title="Login bij Offective en navigeer naar Instellingen - API - beveiligingscode"
			...
			<div id="myModal" class="modal">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h2>
							Welkom <small>bij de Offective koppeling</small>
						</h2>
					</div>
					<div class="modal-body">
						...
						<ul>
							<li>Bij het aanschaffen van deze koppeling is het verstandig
								...
								te zetten</li>
							<li>De <abbr>import settings</abbr> mogen alleen in Offective
								worden gewijzigd.
							</li>
							...
							<li>(Nieuwe) Relaties en materialen op een werkbon worden
								geëxporteerd naar Offective.</li>
						</ul>
						<br>
						...
						<ul>
							<li>Op deze pagina is het mogelijk om de <mark>import</mark>
								en <mark>export</mark> gegevens tussen WerkbonApp en Offective in
								te stellen.
							</li>
						...
						<ul>
							...
							<li><abbr>Werkbonnen met nieuwe relaties en/of
								...
								relaties en/of materialen aangemaakt binnen Offective voordat de
			...
			<form action="settings.do" id="saveOffective">
						...
						<div class="row control-group">
							<div class="form-group col-xs-12 floating-label controls">
								...
								<img src="./img/vraagteken.jpg" data-toggle="tooltip"
									title="Selecteer de objecten die je wilt importeren van Offective naar WerkbonApp"
									height="13" width="13" />
								<div class="checkbox">
									<label>
					...
					<div class="panel-body">
						<div class="row control-group">
							<div class="form-group col-xs-12 floating-label controls">
								...
								<img src="./img/vraagteken.jpg" data-toggle="tooltip"
									title="De werkbon wordt als factuur of offerte verstuurd naar Offective"
									height="13" width="13" />
								<br>
	...
	<script type="text/javascript" src="js/offective.js"></script>
</body>
</html>
